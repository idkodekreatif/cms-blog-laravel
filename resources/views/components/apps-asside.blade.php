<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{ route('dashboard.index') }}">
            <img src="{{ asset('assets/img/logo-back.png') }}" class="navbar-brand-img h-100" alt="main_logo">
            {{-- <span class="ms-1 font-weight-bold">Code Creative</span> --}}
        </a>
    </div>
    ...
    <div class="" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link  {{ request()->is('admin/portofolio*') ? 'active' : '' }}"
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->is('admin/contact-as*') ? 'active' : '' }}"
                    href="{{ route('contact-as.index') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                            <!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                    ...
                    <span class="nav-link-text ms-1">Contact As</span>
                </a>
            </li>
